...
{
    // Class In Hoá Đơn (tham khảo trên Internet)
    internal class ClsPrint
    {
        // Search for "~=>" to edit virtual printing.
        #region Variables
        ...
        public void PrintForm()
        {
            ...
            //{
            //    _printDocument.DocumentName = "KS_O"+ChickStore.Gvar.SoHDHientai;
            //    _printDocument.Print();
            //}

            //    ~=> Print with out Dialog
            //_printDocument.DocumentName = "KS_O" + ChickStore.Gvar.SoHDHientai;
            //_printDocument.Print();
        ...
        private void _printDocument_BeginPrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                strFormat.Alignment = StringAlignment.Center;//CEN_EDIT
